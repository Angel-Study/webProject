...
var GB = {
	...
	popupWindow : {
        ImageUpload :   {tmpl : 'image.html',           width : 700, title : '�� PC �ъ쭊 �ｊ린'},
		ImageUrl :      {tmpl : 'image_url.html',       width : 350, title : '�� �ъ쭊 �ｊ린'},
		Embed :         {tmpl : 'media.html',           width : 430, title : '誘몃뵒��'},
		Table :         {tmpl : 'table.html',           width : 430, title : '�� 留뚮뱾湲�'},
		ModifyTable :   {tmpl : 'table_modify.html',    width : 430, title : '�� 怨좎튂湲�'},
		Layout :        {tmpl : 'layout.html',          width : 430, title : '�덉씠�꾩썐'},
		Link :          {tmpl : 'link.html',            width : 350, title : '�섏씠�쇰쭅��'},
		EmotionIcon :   {tmpl : 'icon.html',            width : 300, title : '�쒖젙 �꾩씠肄�'},
		Symbol :        {tmpl : 'symbol.html',          width : 450, title : '�뱀닔 臾몄옄'},
		GoogleMap :     {tmpl : 'google_map.html',      width : 538, title : '援ш� 吏���'},
		ColorPicker :   {tmpl : 'color_picker.html',    width : 420, title : '�됱긽 �좏깮'},
		FlashMovie :    {tmpl : 'flash.html',           width : 584, title : '�뚮옒�� �숈쁺��'}
    },
	fontName : {
        'kr' : ['留묒� 怨좊뵓', '�뗭�', '援대┝', '諛뷀깢', '沅곸꽌'],
    ...
    listStyle : {
        'ordered' : {
            'decimal':'�レ옄', 'lower-alpha':'�곷Ц �뚮Ц��', 'upper-alpha':'�곷Ц ��臾몄옄', 'lower-roman':'濡쒕쭏 �뚮Ц��', 'upper-roman':'濡쒕쭏 ��臾몄옄'
        },
        'unOrdered' : {'desc':'�숆렇�쇰�', 'circle':'鍮� ��', 'square':'�ш컖��'}
    },
    fontSize : {
	...
	lineHeight : {
        '�� 以� 媛꾧꺽': 1, '1.15': 1.15, '1.5': 1.5, '1.7': 1.7, '1.8': 1.8, '�� 以� 媛꾧꺽': 2
    },
    textBlock : [
...
function setConfig () {
    var config = {
        ...
        editorHeight    : '300px',
        editorFontSize  : '12px',
        editorFontName  : '留묒� 怨좊뵓, 援대┝, Malgun Gothic, gulim',
        editorFontColor : '#000',
        editorBgColor   : '#fff',
        ...
        imgSetAttrWidth : 1, // -1 = (width=100%, height=auto), 0 = �ㅼ젙 �덊븿, 1 = �먮옒��濡�
        imgSetAttrAlt   : true,
        makeThumbnail   : false,
    ...
    if (config.editorPath === null) {
        ...
        if (config.editorPath === null) {
            throw "CHEditor 寃쎈줈媛� 諛붾Ⅴ吏� �딆뒿�덈떎.\nmyeditor.config.editorPath瑜� �ㅼ젙�섏뿬 二쇱떗�쒖삤.";
        }
    }
...
function cheditor () {
    ...
    if (error) {
        alert("CHEditor�� '"+this.browser.name + " " + this.browser.version + "' 踰꾩쟾�� 吏��먰븯吏� �딆뒿�덈떎.");
		return null;
    }
...
checkInputForm : function () {
	...
	if (!textarea) {
		throw "ID媛� '"+this.inputForm+"'�� textarea 媛쒖껜瑜� 李얠쓣 �� �놁뒿�덈떎.";
    }
...
getWindowHandle : function (iframeObj) {
	...
	if (iframeObj.contentWindow) {
		...
		throw '�꾩옱 釉뚮씪�곗��먯꽌 �먮뵒�곕� �ㅽ뻾�� �� �놁뒿�덈떎.';
    }
	return iframeWin;
},
...
initTemplate : function () {
    ...
    function showError(msg) {
        alert(self.templateFile + ' �뚯씪 濡쒕뵫 以� �ㅻ쪟媛� 諛쒖깮�섏��듬땲��.\n�먯씤: ' + msg);
        throw '';
    }
    ...
    if (window.XMLHttpRequest) {
        ...
        try {
            ...
            showError(e + '李멸퀬: �먮뵒�곕� �� �쒕쾭�먯꽌 �ㅽ뻾�섏뿬 二쇱떗�쒖삤.');
        }
        httpRequest.send();
    }
        ...
        showError("�꾩옱 釉뚮씪�곗��먯꽌 "+self.templateFile+" �뚯씪�� �ъ슜�� �� �놁뒿�덈떎.");
    }
},
...
toolbarUpdate : function () {
	...
	for (i in toolbar) {
        ...
        case 'FormatBlock' :
			...
			if (!el) {
                span.appendChild(document.createTextNode('�ㅽ���'));
				wrapper.replaceChild(span, oldName);
			}
...
showToolbar : function (toolbar, toolbarWrapper) {
    ...
    if (self.config.useFullScreen === true) {
        ...
        fullscreen.setAttribute("title", "�꾩껜 �붾㈃");
        fullscreen.onclick = function() {
            if (self.setFullScreenMode) {
                this.className = "cheditor-tb-fullscreen";
                this.setAttribute("title", "�꾩껜 �붾㈃");
            }
            else {
                this.className = "cheditor-tb-fullscreen-actual";
                this.setAttribute("title", "�댁쟾 �ш린濡� 蹂듭썝");
            }
            self.fullScreenMode();
        };
    }
...
loadTemplate : function (xmlDoc) {
	...
	if (tmpl.getElementsByTagName('Image').item(0).getAttribute('file') === null) {
        throw '�대컮 �꾩씠肄� �대�吏� �뚯씪 �대쫫�� �뺤쓽�섏� �딆븯�듬땲��.';
    }
...
showFontSizeMenu : function (pNode) {
    ...
    if (!elem) {
        ...
        for (i=0; i < len; i++) {
            ...
            div = document.createElement('div');
            label = document.createElement('label');
            text = size > 48 ? '媛�' : (size > 28 ? '媛��섎떎' : '媛��섎떎��');
...
showTextBlockMenu : function (pNode) {
	...
	if (!elem) {
		...
		for (i=0; i < quote.length; i++) {
			...
			label = document.createElement('label');
			label.appendChild(document.createTextNode('媛��섎떎�� ABC'));
			div.appendChild(label);
...
setColorTable : function (menu) {
    ...
    var showTooltip = 'ë” ë§Žì€ ìƒ‰ ë³´ê¸°'; var hideTooltip = 'ê°ì¶”ê¸°';
...
windowOpen : function (popupName) {
	...
	if (!(this.undefined(GB.popupWindow[popupName]))) {
        ...
        alert('ì‚¬ìš©í•  ìˆ˜ ì—†ëŠ” ëª…ë ¹ìž…ë‹ˆë‹¤.');
    }
},
...
doCmd : function (cmd, opt) {
	...
	if (!GB.browser.msie && (cmd === 'Cut' || cmd === 'Copy' || cmd === 'Paste')) {
        if ((range.execCommand(cmd, false, opt)) !== true) {
            ...
            var command = '';
            switch (cmd) {
                case 'Cut'  : keyboard = 'x'; command = 'ìžë¥´ê¸°'; break;
	...
	try {
		...
		alert(cmd + ": ì§€ì›ë˜ì§€ ì•ŠëŠ” ëª…ë ¹ìž…ë‹ˆë‹¤." + e.toString());
	}
...
modifyImage : function (img) {
	...
	var imageWidthOpt = {
		...
		"fitpage" : {"size": "100%", "desc": "íŽ˜ì´ì§€ í¬ê¸°ì— ë§žì¶¤"}
    };
...
modifyCell : function (ctd) {
    ...
    var funcs = {
            'add_cols_after' : { 'icon' : 'table_insert_column.png', 'title' : 'ì—´ ì‚½ìž…',
                'func' : function() { insertColumn(ctd.cellIndex); tblReflash(); }},
            'add_rows_after': { 'icon' : 'table_insert_row.png', 'title' : 'í–‰ ì‚½ìž…',
            ...
            'merge_cell_down': { 'icon' : 'table_join_column.png', 'title' : 'ì•„ëž˜ ì…€ê³¼ ë³‘í•©',
